...
import Model.Repo exposing (Repo, decodeRepo)
...
personalDetails =
    ...
    , contacts = [ DetailWithName "email" "fazakasedina1999@yahoo.com" ]
    , socials = [ DetailWithName "github" "https://github.com/edinafazakas" ]
    }
